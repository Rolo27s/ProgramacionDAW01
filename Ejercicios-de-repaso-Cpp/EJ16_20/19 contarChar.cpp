...
int main(){
    ...
    int nf, size[N], cont[N];
    char c/* , cMayus, cMinus */;
    ...
    do
    {
        ...
        cout << "Programa que cuenta si un caracter se encuentra en en una serie de frases\n";
        cout << "-------------------------------------------------------------------------\n\n";
        ...
        cin>>c;
        // Me aseguro de tener guardada el caracter en mayusculas y en minusculas (Me doy cuenta que no hacia falta y lo comento)
/*         cMayus = toupper(c);
        cMinus = tolower(c); */
        ...
        cout << "Programa que cuenta si un caracter se encuentra en en una serie de frases\n";
        cout << "-------------------------------------------------------------------------\n\n";
        cout << "Nro.  \t     Frase o cadena de inicial  \t\t     Numero de caracteres  \n";
        cout << "----  \t    ---------------------------  \t\t  -----------------------  \n";

        for(int i = 0; i < nf; i++){
            if(cont[i] == 1){
                cout << i+1 << "\t\t" << frase[i] << "  \t\t\t  " <<  cont[i] << " vez" << endl; 
            }else{
                cout << i+1 << "\t\t" << frase[i] << "  \t\t\t  " <<  cont[i] << " veces" << endl;
            }

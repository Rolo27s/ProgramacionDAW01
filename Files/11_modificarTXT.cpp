...
using namespace std;
const int N = 100; // Mi listado tendra de momento 100 registros como máximo
...
int main()
{
    ...
    do
    {
        ...
        if (editAsesor == 'S' || editAsesor == 's')
        {
            ...
            /* Al usar una funcion como argumento condicional, ejecuto una vez al menos dicha funcion. No necesito hacer llamada explicita, ya que está llamandose una ve de manera implícita */
...
int leerGuardar(string name)
{
    ...
    /* La propiedad .c_str() sirve para cuando le introduces el nombre por teclado. En este caso nombreArchivo.c_str() no sería necesario porque se lo estoy dando desde el codigo fuente */
